...
var _runtime = require("regenerator-runtime/runtime"); //polifiling async/await
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","regenerator-runtime":"dXNgZ","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./model.js":"Y4A21","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs"}],"gkKU3":[function(require,module,exports) {
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./View.js":"5cUXS","fracty":"hJO4d"}],"cMpiy":[function(require,module,exports) {
...
class View {
    ...
    update(data) {
        ...
        // create new node DOM object live in the memory
        const newDOM = document.createRange().createContextualFragment(newMarkup);
        const newElements = Array.from(newDOM.querySelectorAll("*"));
        const curElements = Array.from(this._parantElement.querySelectorAll("*"));
        newElements.forEach((newEl, i)=>{
            const curEl = curElements[i];
            // Updates changed TEXT
            if (!newEl.isEqualNode(curEl) && newEl.firstChild?.nodeValue.trim() !== "") curEl.textContent = newEl.textContent;
            // Update changed attriebues
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hJO4d":[function(require,module,exports) {
...
const KEY = "04cebc2b-488e-43af-8a6e-5dd0f7c9f869";
...
},{"regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cSbZE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class ResaultView extends (0, _viewJsDefault.default) {
...
class PaginationView extends (0, _viewJsDefault.default) {
    _parantElement = document.querySelector(".pagination");
    ...
    _generateMarkup() {
        const cuePage = this._data.page;
        const numPages = Math.ceil(this._data.results.length / this._data.resultsPerPage);
        // Page 1, and there are other pages
        if (cuePage === 1 && numPages > 1) return `
        <button data-goto = "${cuePage + 1}" class="btn--inline pagination__btn--next">
          <span>Page ${cuePage + 1}</span>
          <svg class="search__icon">
            <use href="${0, _iconsSvgDefault.default}#icon-arrow-right"></use>
          </svg>
        </button>
        `;
        // Last page
        if (cuePage === numPages && numPages > 1) return ` 
        <button data-goto = "${cuePage - 1}" class="btn--inline pagination__btn--prev">
          <svg class="search__icon">
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    _parantElement = document.querySelector(".upload");
